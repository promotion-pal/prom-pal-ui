...
function PromSelectGroup({
  ...props
}: React.ComponentProps<typeof SelectPrimitive.Group>) {
  return <SelectPrimitive.Group data-slot="select-group" {...props} />;
}

function PromSelectValue({
  ...props
}: React.ComponentProps<typeof SelectPrimitive.Value>) {
  return <SelectPrimitive.Value data-slot="select-value" {...props} />;
}

function PromSelectTrigger({
  className,
  size = "default",
  children,
  ...props
  ...
  return (
    <SelectPrimitive.Portal>
      ...
      >
        ...
        <PromSelectScrollDownButton />
      </SelectPrimitive.Content>
    </SelectPrimitive.Portal>
  );
}

function PromSelectLabel({
  className,
  ...props
...
function PromSelectScrollUpButton({
  className,
  ...props
...
function PromSelectScrollDownButton({
  className,
  ...props
